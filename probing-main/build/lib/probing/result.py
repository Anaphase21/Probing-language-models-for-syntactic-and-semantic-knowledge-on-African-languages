...
class Result:
    __slots__ = ('train_loss', 'dev_loss', 'train_acc', 'dev_acc', 'train_f1_score',
                 'dev_f1_score', 'running_time', 'start_time', 'train_size', 'dev_size',
    ...
    def merge(self, other):
        for i in range(len(other.train_loss)):
            ...
            self.train_f1_score.append(other.train_f1_score[i])
            self.dev_f1_score.append(other.dev_f1_score[i])
